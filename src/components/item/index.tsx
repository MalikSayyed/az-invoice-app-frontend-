...
const Item: React.FC = () => {
  ...
  const handleAddItemClick = async () => {
    try {
      const response = await axios.post(
        "https://d3a7975fhwm13k.cloudfront.net/item/add-item",
        {
          token: sessionStorage.getItem("loginToken"),
          item_name: itemName,
          item_code: itemCode,
  ...
  const handleEditItemClick = async () => {
    try {
      await axios.put(
        "https://d3a7975fhwm13k.cloudfront.net/item/update-item",
        {
          id: selectedItemId,
          item_name: itemName,
          item_code: itemCode,
  ...
  const handleDeleteItemClick = async () => {
    try {
      const response = await axios.delete(
        "https://d3a7975fhwm13k.cloudfront.net/item/remove-item",
        {
          params: {
            id: selectedItemId,
          },
