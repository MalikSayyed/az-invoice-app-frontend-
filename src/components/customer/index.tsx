...
const Customer: React.FC = () => {
  ...
  const fetchCustomersData = async () => {
    const response = await axios.get(
      "https://d2nxa7pir92htg.cloudfront.net/customer/get-customers",
      {
        params: {
  ...
  const handleAddCustomerClick = async () => {
    try {
      const response = await axios.post(
        "https://d2nxa7pir92htg.cloudfront.net/customer/add-customer",
        {
          token: sessionStorage.getItem("loginToken"),
          name: customerName,
          email: customerEmail,
  ...
  const handleEditCustomerClick = async () => {
    try {
      await axios.put(
        "https://d2nxa7pir92htg.cloudfront.net/customer/update-customer",
        {
  ...
  const handleDeleteCustomerClick = async () => {
    try {
      const response = await axios.delete(
        "https://d2nxa7pir92htg.cloudfront.net/customer/remove-customer",
        {
          params: {
            id: selectedCustomerId,
          },
