...
export function useReportData(
  ...
  const fetchCompaniesReport = async () => {
    const response = await axios.get(
      "https://d2nxa7pir92htg.cloudfront.net/company/get-companies-report",
      {
        params: {
  ...
  const fetchItemsReport = async () => {
    const response = await axios.get(
      "https://d2nxa7pir92htg.cloudfront.net/item/get-items-report",
      {
        params: {
          token: sessionStorage.getItem("loginToken"),
          companyId,
  ...
  const fetchCustomersReport = async () => {
    const response = await axios.get(
      "https://d2nxa7pir92htg.cloudfront.net/customer/get-customers-report",
      {
        params: {
          token: sessionStorage.getItem("loginToken"),
          companyId,
  ...
  const fetchInvoicesReport = async () => {
    const response = await axios.get(
      "https://d2nxa7pir92htg.cloudfront.net/invoice/get-invoices-report",
      {
        params: {
          token: sessionStorage.getItem("loginToken"),
          companyId,
